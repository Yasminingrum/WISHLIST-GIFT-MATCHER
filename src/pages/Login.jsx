...
import { useAuth, AUTH_ERROR } from "../context/AuthContext";
import "./Auth.css";
...
export default function Login() {
  ...
  const successMsg = location.state?.verifiedMessage || "";
  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      if (err.code === AUTH_ERROR.GOOGLE_USER_NOT_REGISTERED) {
        navigate("/register", {
          state: {
            googleNotRegistered: true,
            message: "Akun Google-mu belum terdaftar. Silakan daftar terlebih dahulu.",
          },
        });
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <Link
                to="/forgot-password"
                style={{ fontSize: "0.82rem", color: "var(--rose)", fontWeight: 500 }}
              >
                Lupa password?
              </Link>
            </div>
