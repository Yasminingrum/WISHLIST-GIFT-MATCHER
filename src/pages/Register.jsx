...
export default function Register() {
  ...
  // Banner jika diarahkan dari Login karena Google belum terdaftar
  const googleNotRegistered = location.state?.googleNotRegistered || false;
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card card slide-up">
        ...
        {/* Banner khusus jika diarahkan dari Google login yang belum terdaftar */}
        {googleNotRegistered && redirectMessage && (
